<!-- First Container -->
<div class="container-fluid bg-1 text-left" style="position:relative;padding:0;">
    <div id="particles-topper"></div>
...
<script type="text/javascript">
    var canvasDiv = document.getElementById('particles-topper');
    var options = {
